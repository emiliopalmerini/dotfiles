return {
    ...
    config = function ()
        ...
        vim.keymap.set('n', '<leader>bp', ":lua require'dap'.toggle_breakpoint()<CR>", {buffer=0})
        vim.keymap.set('n', '<leader>Bp', ":lua require'dap'.set_breakpoint(vim.fn.input('Breakpoint condition: '))<CR>", {buffer=0})
