...

{
  ...
  fileSystems."/" =
    { device = "/dev/disk/by-uuid/8cf7d785-96a3-43d2-9100-88b621ccb345";
      fsType = "ext4";
    };

  fileSystems."/boot" =
    { device = "/dev/disk/by-uuid/EA8C-BB90";
      fsType = "vfat";
      options = [ "fmask=0077" "dmask=0077" ];
    };

  swapDevices =
    [ { device = "/dev/disk/by-uuid/abb4540b-bcdf-4764-a5c8-87ecc85e3b50"; }
    ];
